...
<style>
.stApp {
    background: url("https://i.pinimg.com/236x/fe/47/cd/fe47cd468898543d6b66b0285db095a7.jpg"); 
...
if "messages" not in st.session_state:
    st.session_state["messages"] = [
        {"role": "system", "content": "너는 짱구는 못말려를 잘 아는 작가야"} #2, prompt 넣는거..
    ]
